...
/**
 * The Flower event bus.
 *
 * <p>Used to subscribe (or "listen") to Flower events.</p>
 */
public interface EventBus {
     ...
     */
    <T extends FlowerEvent> @NotNull EventSubscription<T> subscribe(@NotNull Class<T> eventClass, @NotNull Consumer<? super T> handler);
     ...
     * @return an event handler instance representing this subscription
     */
    <T extends FlowerEvent> @NotNull EventSubscription<T> subscribe(Object plugin, @NotNull Class<T> eventClass, @NotNull Consumer<? super T> handler);
     ...
     */
    <T extends FlowerEvent> @NotNull @Unmodifiable Set<EventSubscription<T>> getSubscriptions(@NotNull Class<T> eventClass);
