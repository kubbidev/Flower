...
import net.flower.api.util.Result;
...
/**
 * Called when Flower has finished processing a Player's initial connection.
 *
 * <p>This event will always execute during the platforms async connection
 * event. The Flower platform listener processing the connection will block
 ...
 * successful. Note that Flower will usually cancel the platform connection
 * event if data could not be loaded.</p>
 */
public interface PlayerLoginProcessEvent extends FlowerEvent, Result {
