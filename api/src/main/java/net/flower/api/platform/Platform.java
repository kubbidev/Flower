...
/**
 * Provides information about the platform Flower is running on.
 */
public interface Platform {

    /**
     * Gets the type of platform Flower is running on
     *
     * @return the type of platform Flower is running on
     */
    ...
    /**
     * Represents a type of platform which Flower can run on.
     */
    enum Type {
        BUKKIT("Bukkit"),
