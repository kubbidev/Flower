...
public interface MessagingService {
     ...
     * already built into Flower.</p>
     *
     * <p>It is <b>not</b> intended as a full message broker replacement/abstraction.
     * Note that some of the messenger implementations in Flower cannot handle
     ...
     * functionality to send messages that have nothing to do with Flower or
     ...
     *
     * <p>Other Flower instances that receive the message will publish it to API
