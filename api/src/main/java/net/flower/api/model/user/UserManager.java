package net.flower.api.model.user;
...
public interface UserManager {
    ...
    /**
     * Uses the Flower cache to find a uuid for the given username.
     *
    ...
    /**
     * Uses the Flower cache to find a username for the given uuid.
     *
     ...
     * @throws IllegalStateException if the user instance was not obtained from Flower.
     */
