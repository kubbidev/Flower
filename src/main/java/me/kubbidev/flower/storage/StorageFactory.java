package me.kubbidev.flower.storage;
...
import me.kubbidev.flower.storage.implementation.custom.CustomStorageProviders;
import me.kubbidev.flower.storage.implementation.file.CombinedConfigurateStorage;
import me.kubbidev.flower.storage.implementation.file.SeparatedConfigurateStorage;
import me.kubbidev.flower.storage.implementation.file.loader.HoconLoader;
import me.kubbidev.flower.storage.implementation.file.loader.JsonLoader;
import me.kubbidev.flower.storage.implementation.file.loader.TomlLoader;
import me.kubbidev.flower.storage.implementation.file.loader.YamlLoader;
import me.kubbidev.flower.storage.implementation.mongodb.MongoStorage;
import me.kubbidev.flower.storage.implementation.split.SplitStorage;
import me.kubbidev.flower.storage.implementation.split.SplitStorageType;
import me.kubbidev.flower.storage.implementation.sql.SqlStorage;
import me.kubbidev.flower.storage.implementation.sql.connection.file.H2ConnectionFactory;
import me.kubbidev.flower.storage.implementation.sql.connection.file.SqliteConnectionFactory;
...
public class StorageFactory {
    ...
    public StorageFactory(FlowerPlugin plugin) {
        this.plugin = plugin;
    }
    ...
    private StorageImplementation createNewImplementation(StorageType method) {
        switch (method) {
            ...
            case SQLITE:
                return new SqlStorage(
                        this.plugin,
                        new SqliteConnectionFactory(this.plugin.getBootstrap().getDataDirectory().resolve("flower-sqlite.db")),
                        this.plugin.getConfiguration().get(ConfigKeys.SQL_TABLE_PREFIX)
                );
            case H2:
                return new SqlStorage(
                        this.plugin,
                        new H2ConnectionFactory(this.plugin.getBootstrap().getDataDirectory().resolve("flower-h2-v2")),
                        this.plugin.getConfiguration().get(ConfigKeys.SQL_TABLE_PREFIX)
                );
            case POSTGRESQL:
                return new SqlStorage(
