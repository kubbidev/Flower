package me.kubbidev.flower.storage.implementation.file.watcher;

import me.kubbidev.flower.plugin.FlowerPlugin;
import me.kubbidev.flower.util.ExpiringSet;
import me.kubbidev.flower.util.Iterators;
...
/**
 * Simple implementation of {@link AbstractFileWatcher} for Flower data files.
 */
public class FileWatcher extends AbstractFileWatcher {
    ...
    public FileWatcher(FlowerPlugin plugin, Path basePath) throws IOException {
