package me.kubbidev.flower.storage.implementation.sql;
...
//    private static final String PLAYER_UPDATE_PRIMARY_GROUP_BY_UUID = "UPDATE '{prefix}players' SET primary_group=? WHERE uuid=?";
    ...
    public SqlStorage(FlowerPlugin plugin, ConnectionFactory connectionFactory, String tablePrefix) {
        this.plugin = plugin;
    ...
    private void applySchema() throws IOException, SQLException {
        ...
        String schemaFileName = "me/kubbidev/flower/schema/" + this.connectionFactory.getImplementationName().toLowerCase(Locale.ROOT) + ".sql";
