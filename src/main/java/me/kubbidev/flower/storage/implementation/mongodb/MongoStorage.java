package me.kubbidev.flower.storage.implementation.mongodb;
...
public class MongoStorage implements StorageImplementation {
    ...
    public MongoStorage(FlowerPlugin plugin, StorageCredentials configuration, String prefix, String connectionUri) {
        this.plugin = plugin;
