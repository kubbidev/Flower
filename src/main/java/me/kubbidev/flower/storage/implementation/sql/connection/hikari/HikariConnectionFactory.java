package me.kubbidev.flower.storage.implementation.sql.connection.hikari;
...
import me.kubbidev.flower.storage.implementation.sql.connection.ConnectionFactory;
...
public abstract class HikariConnectionFactory implements ConnectionFactory {
    ...
    public void init(FlowerPlugin plugin) {
        ...
        config.setPoolName("flower-hikari");
    ...
    private static void handleClassloadingError(Throwable throwable, FlowerPlugin plugin) {
        ...
        logger.warn("Please check for other plugins below (and try loading Flower without them installed) before reporting the issue.");
