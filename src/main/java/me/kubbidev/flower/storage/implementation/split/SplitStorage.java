package me.kubbidev.flower.storage.implementation.split;
...
public class SplitStorage implements StorageImplementation {
    ...
    public SplitStorage(FlowerPlugin plugin, Map<StorageType, StorageImplementation> implementations, Map<SplitStorageType, StorageType> types) {
        this.plugin = plugin;
