...
public class SimpleExtensionManager implements ExtensionManager, AutoCloseable {
    ...
    public SimpleExtensionManager(FlowerPlugin plugin) {
        this.plugin = plugin;
    }
    ...
    public @NotNull Extension loadExtension(Path path) throws IOException {
        ...
        try {
            Constructor<? extends Extension> constructor = extensionClass.getConstructor(Flower.class);
