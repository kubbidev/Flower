package me.kubbidev.flower.messaging.nats;
...
import me.kubbidev.flower.util.Throwing;
...
public class NatsMessenger implements Messenger {
    ...
    private static final String CHANNEL = "flower:update";
    ...
    public NatsMessenger(FlowerPlugin plugin, IncomingMessageConsumer consumer) {
        this.plugin = plugin;
