...
import me.kubbidev.flower.messaging.message.CustomMessageImpl;
...
public class FlowerMessagingService implements InternalMessagingService, IncomingMessageConsumer {
    ...
    public FlowerMessagingService(FlowerPlugin plugin, MessengerProvider messengerProvider) {
        this.plugin = plugin;
    ...
    public boolean consumeIncomingMessage(@NotNull Message message) {
        ...
        // it means an instance of Flower can gracefully handle messages it doesn't
