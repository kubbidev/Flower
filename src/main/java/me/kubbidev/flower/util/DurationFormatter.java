...
public class DurationFormatter {
    ...
    //   flower.duration.unit.years.plural={0} years
    //   flower.duration.unit.years.singular={0} year
    //   flower.duration.unit.years.short={0}y
    // ... and so on
    ...
    private TranslatableComponent formatPart(long amount, ChronoUnit unit) {
        ...
        String translationKey = "flower.duration.unit." + unit.name().toLowerCase(Locale.ROOT) + "." + format;
