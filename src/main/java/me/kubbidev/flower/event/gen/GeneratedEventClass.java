...
import me.kubbidev.flower.cache.LoadingMap;
...
/**
 * Holds the generated event class for a given type of {@link FlowerEvent}.
 */
public class GeneratedEventClass {
     ...
     */
    private static final Map<Class<? extends FlowerEvent>, GeneratedEventClass> CACHE = LoadingMap.of(clazz -> {
        try {
     ...
     */
    public static GeneratedEventClass generate(Class<? extends FlowerEvent> event) {
    ...
    public static void preGenerate() {
        for (Class<? extends FlowerEvent> eventType : EventDispatcher.getKnownEventTypes()) {
            generate(eventType);
        }
    }
    ...
    private GeneratedEventClass(Class<? extends FlowerEvent> eventClass) throws Throwable {
        ...
        String eventClassSuffix = eventClass.getName().substring(FlowerEvent.class.getPackage().getName().length());
        ...
        DynamicType.Builder<AbstractEvent> builder = new ByteBuddy(ClassFileVersion.JAVA_V8)
                ...
                // implement FlowerEvent#getEventType by returning the event class type
        ...
        this.constructor = MethodHandles.publicLookup().in(generatedClass)
                .findConstructor(generatedClass, MethodType.methodType(void.class, Flower.class))
                .asType(MethodType.methodType(AbstractEvent.class, Flower.class));
     ...
     *
     * @param api an instance of the Flower API
     * @param properties the event properties
     * @return the event instance
     * @throws Throwable if something goes wrong
     */
    public FlowerEvent newInstance(Flower api, Object... properties) throws Throwable {
