 ...
 */
public class FlowerEventSubscription<T extends FlowerEvent> implements EventSubscription<T>, EventSubscriber<T> {
    ...
    public FlowerEventSubscription(AbstractEventBus<?> eventBus, Class<T> eventClass, Consumer<? super T> consumer, @Nullable Object plugin) {
