...
import me.kubbidev.flower.event.gen.GeneratedEventClass;
import me.kubbidev.flower.model.User;
import net.flower.api.event.FlowerEvent;
import net.flower.api.event.extension.ExtensionLoadEvent;
import net.flower.api.event.messaging.CustomMessageReceiveEvent;
import net.flower.api.event.player.PlayerDataSaveEvent;
import net.flower.api.event.player.PlayerLoginProcessEvent;
import net.flower.api.event.player.lookup.UniqueIdDetermineTypeEvent;
import net.flower.api.event.player.lookup.UniqueIdLookupEvent;
import net.flower.api.event.player.lookup.UsernameLookupEvent;
import net.flower.api.event.player.lookup.UsernameValidityCheckEvent;
import net.flower.api.event.sync.ConfigReloadEvent;
import net.flower.api.event.sync.PostSyncEvent;
import net.flower.api.event.sync.PreSyncEvent;
import net.flower.api.event.type.Cancellable;
import net.flower.api.event.type.ResultEvent;
import net.flower.api.event.user.UserFirstLoginEvent;
import net.flower.api.event.user.UserLoadEvent;
import net.flower.api.event.user.UserUnloadEvent;
...
public final class EventDispatcher {
    ...
    private FlowerEvent generate(Class<? extends FlowerEvent> eventClass, Object... params) {
        try {
    ...
    private void post(Class<? extends FlowerEvent> eventClass, Object... params) {
        FlowerEvent event = generate(eventClass, params);
        this.eventBus.post(event);
    }

    private void postAsync(Class<? extends FlowerEvent> eventClass, Object... params) {
    ...
    private void postSync(Class<? extends FlowerEvent> eventClass, Object... params) {
    ...
    private boolean postCancellable(Class<? extends FlowerEvent> eventClass, Object... params) {
    ...
    public static Class<? extends FlowerEvent>[] getKnownEventTypes() {
        return new Class[]{
