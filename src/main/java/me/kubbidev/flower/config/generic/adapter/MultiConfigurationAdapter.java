...
public class MultiConfigurationAdapter implements ConfigurationAdapter {
     ...
     */
    public MultiConfigurationAdapter(FlowerPlugin plugin, List<ConfigurationAdapter> adapters) {
        this.plugin = plugin;
        this.adapters = ImmutableList.copyOf(adapters).reverse();
    }

    public MultiConfigurationAdapter(FlowerPlugin plugin, ConfigurationAdapter... adapters) {
