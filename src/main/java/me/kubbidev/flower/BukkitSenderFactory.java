...
import me.kubbidev.flower.sender.SenderFactory;
...
public class BukkitSenderFactory extends SenderFactory<FBukkitPlugin, CommandSender> {

    public BukkitSenderFactory(FBukkitPlugin plugin) {
        super(plugin);
    }
    ...
    protected void sendMessage(CommandSender sender, Component message) {
        ...
        if (sender instanceof Player || sender instanceof ConsoleCommandSender || sender instanceof RemoteConsoleCommandSender) {
            ...
            getPlugin().getBootstrap().getScheduler().executeSync(() -> sender.sendMessage(message));
        }
    }
