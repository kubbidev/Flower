...
import me.kubbidev.flower.command.spec.Argument;
...
public abstract class SingleCommand extends Command<Void> {
    ...
    @Override
    public final void execute(FlowerPlugin plugin, Sender sender, Void ignored, ArgumentList args, String label) throws CommandException {
        execute(plugin, sender, args, label);
    }

    public abstract void execute(FlowerPlugin plugin, Sender sender, ArgumentList args, String label) throws CommandException;
