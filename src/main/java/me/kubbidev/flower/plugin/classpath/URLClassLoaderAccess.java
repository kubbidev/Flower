...
public abstract class URLClassLoaderAccess {
    ...
    private static void throwError(Throwable cause) throws UnsupportedOperationException {
        throw new UnsupportedOperationException("Flower is unable to inject into the plugin URLClassLoader.\n" +
     ...
     *
     * @author Vaishnav Anil (<a href="https://github.com/slimjar/slimjar">Github</a>)
     */
