package me.kubbidev.flower.locale;
...
import me.kubbidev.flower.util.DurationFormatter;
...
public interface Message {
    ...
    Args1<FlowerBootstrap> STARTUP_BANNER = bootstrap -> {
        Component infoLine1 = text()
                .append(text(AbstractFlowerPlugin.getPluginName(), DARK_GREEN))
                .append(space())
    ...
    Args2<String, Component> COMMAND_USAGE_DETAILED_HEADER = (name, usage) -> joinNewline(
            ...
            // "&b> &7{}"
            prefixed(text()
                    .append(translatable("flower.commandsystem.usage.usage-header", DARK_AQUA, BOLD))
                    .append(text(" - ", DARK_AQUA))
    ...
    Args0 COMMAND_USAGE_DETAILED_ARGS_HEADER = () -> prefixed(translatable()
            // "&3Arguments:"
            .key("flower.commandsystem.usage.arguments-header")
            .color(DARK_AQUA)
            .append(text(':'))
    );
    ...
    Args1<String> VIEW_AVAILABLE_COMMANDS_PROMPT = label -> prefixed(translatable()
            ...
            .key("flower.commandsystem.available-commands")
            .color(DARK_AQUA)
    ...
    Args0 NO_PERMISSION_FOR_SUBCOMMANDS = () -> prefixed(translatable()
            ...
            .key("flower.commandsystem.no-permission-subcommands")
            .color(DARK_AQUA)
            .append(FULL_STOP)
    );
    ...
    Args0 ALREADY_EXECUTING_COMMAND = () -> prefixed(translatable()
            ...
            .key("flower.commandsystem.already-executing-command")
            .color(GRAY)
    );

    Args0 CONSOLE_NOT_ALLOWED_COMMAND = () -> prefixed(translatable()
            // "&cCould not execute this command as the console."
            .key("flower.commandsystem.console-not-allowed-command")
            .append(FULL_STOP)
            .color(RED)
    );
    ...
    Args0 COMMAND_NOT_RECOGNISED = () -> prefixed(translatable()
            ...
            .key("flower.commandsystem.command-not-recognised")
            .color(RED)
            .append(FULL_STOP)
    );
    ...
    Args0 COMMAND_NO_PERMISSION = () -> prefixed(translatable()
            ...
            .key("flower.commandsystem.no-permission")
            .color(RED)
    );
    ...
    Args2<String, String> MAIN_COMMAND_USAGE_HEADER = (name, usage) -> prefixed(text()
            ...
            .append(text(name))
            .append(space())
            .append(translatable("flower.commandsystem.usage.sub-commands-header"))
            .append(text(": "))
            .append(text()
                    .color(GRAY)
                    .append(OPEN_BRACKET)
    ...
    Args1<String> ILLEGAL_DATE_ERROR = invalid -> prefixed(translatable()
            ...
            .key("flower.command.misc.date-parse-error")
            .color(RED)
    ...
    Args0 PAST_DATE_ERROR = () -> prefixed(translatable()
            ...
            .key("flower.command.misc.date-in-past-error")
            .color(RED)
    );

    Args1<String> USER_NOT_FOUND = id -> prefixed(translatable()
            // "&cA user for &4{}&c could not be found."
            .key("flower.command.misc.loading.error.user-not-found")
            .color(RED)
    ...
    Args1<String> USER_INVALID_ENTRY = invalid -> prefixed(translatable()
            ...
            .key("flower.command.misc.loading.error.user-invalid")
            .color(RED)
            .arguments(text(invalid, DARK_RED))
            .append(FULL_STOP)
    );
    ...
    Args0 LOADING_DATABASE_ERROR = () -> prefixed(translatable()
            ...
            .key("flower.login.loading-database-error")
            .color(RED)
            .append(FULL_STOP)
            .append(space())
            .append(translatable("flower.login.try-again"))
            .append(FULL_STOP)
            .append(space())
            .append(translatable("flower.login.server-admin-check-console-errors"))
            .append(FULL_STOP)
    );
    ...
    Args0 LOADING_STATE_ERROR = () -> prefixed(translatable()
            ...
            .key("flower.login.data-not-loaded-at-pre")
            .color(RED)
            .append(text(" - "))
            .append(translatable("flower.login.unable-to-continue"))
            .append(FULL_STOP)
            .append(space())
            .append(translatable("flower.login.try-again"))
            .append(FULL_STOP)
    ...
    Args0 LOADING_STATE_ERROR_CB_OFFLINE_MODE = () -> prefixed(translatable()
            ...
            .color(RED)
            .append(text(" - "))
            .append(translatable("flower.login.craftbukkit-offline-mode-error"))
            .append(FULL_STOP)
            .append(space())
            .append(translatable("flower.login.server-admin-check-console-info"))
            .append(FULL_STOP)
    );
    ...
    Args0 UPDATE_TASK_REQUEST = () -> prefixed(translatable()
            ...
            .color(AQUA)
            .key("flower.command.update-task.request")
            .append(FULL_STOP)
    );
    ...
    Args0 UPDATE_TASK_COMPLETE = () -> prefixed(translatable()
            ...
            .color(GREEN)
            .key("flower.command.update-task.complete")
            .append(FULL_STOP)
    );
    ...
    Args0 RELOAD_CONFIG_SUCCESS = () -> prefixed(translatable()
            ...
            .key("flower.command.reload-config.success")
            .color(GREEN)
            .append(FULL_STOP)
            .append(space())
            .append(text()
                    .color(GRAY)
                    .append(OPEN_BRACKET)
                    .append(translatable("flower.command.reload-config.restart-note"))
                    .append(CLOSE_BRACKET)
            )
    );

    Args2<FlowerPlugin, StorageMetadata> INFO = (plugin, storageMeta) -> joinNewline(
            // "&2Running &bFlower v{}&2 by &bkubbidev&2."
            // "&f-  &3Platform: &f{}"
            // "&f-  &3Server Brand: &f{}"
            // "&f-  &3Server Version:"
            // "     &f{}"
            ...
            prefixed(translatable()
                    .key("flower.command.info.running-plugin")
                    .color(DARK_GREEN)
                    .append(space())
                    .append(text(AbstractFlowerPlugin.getPluginName(), AQUA))
                    .append(space())
            ...
            prefixed(text()
                    .color(DARK_AQUA)
                    .append(text("-  ", WHITE))
                    .append(translatable("flower.command.info.platform-key"))
                    .append(text(": "))
                    .append(text(plugin.getBootstrap().getType().getFriendlyName(), WHITE))),
            prefixed(text()
                    .color(DARK_AQUA)
                    .append(text("-  ", WHITE))
                    .append(translatable("flower.command.info.server-brand-key"))
                    .append(text(": "))
                    .append(text(plugin.getBootstrap().getServerBrand(), WHITE))),
            prefixed(text()
                    .color(DARK_AQUA)
                    .append(text("-  ", WHITE))
                    .append(translatable("flower.command.info.server-version-key"))
                    .append(text(':'))),
            prefixed(text()
                    .color(WHITE)
                    .append(text("     "))
            ...
            prefixed(text()
                    .color(AQUA)
                    .append(text("-  ", WHITE))
                    .append(translatable("flower.command.info.storage-key"))
                    .append(text(':'))),
            prefixed(text()
                    .apply(builder -> {
                        builder.append(text()
                                .color(DARK_AQUA)
                                .append(text("     "))
                                .append(translatable("flower.command.info.storage-type-key"))
                                .append(text(": "))
                        ...
                        if (storageMeta.connected() != null) {
                            ...
                            builder.append(prefixed(text()
                                    .color(DARK_AQUA)
                                    .append(text("     "))
                                    .append(translatable("flower.command.info.storage.meta.connected-key"))
                                    .append(text(": "))
                        ...
                        if (storageMeta.ping() != null) {
                            ...
                            builder.append(prefixed(text()
                                    .color(DARK_AQUA)
                                    .append(text("     "))
                                    .append(translatable("flower.command.info.storage.meta.ping-key"))
                                    .append(text(": "))
                        ...
                        if (storageMeta.sizeBytes() != null) {
                            ...
                            builder.append(prefixed(text()
                                    .color(DARK_AQUA)
                                    .append(text("     "))
                                    .append(translatable("flower.command.info.storage.meta.file-size-key"))
                                    .append(text(": "))
            ...
            prefixed(text()
                    .color(AQUA)
                    .append(text("-  ", WHITE))
                    .append(translatable("flower.command.info.extensions-key"))
                    .append(text(':'))),
            prefixed(text()
                    .color(WHITE)
                    .append(text("     "))
            ...
            prefixed(text()
                    .color(AQUA)
                    .append(text("-  ", WHITE))
                    .append(translatable("flower.command.info.messaging-key"))
                    .append(text(": "))
                    .append(plugin.getMessagingService().<Component>map(s -> Component.text(s.getName(), WHITE)).orElse(translatable("flower.command.misc.none", WHITE)))),
            prefixed(text()
                    .color(AQUA)
                    .append(text("-  ", WHITE))
                    .append(translatable("flower.command.info.instance-key"))
                    .append(text(':'))),
            prefixed(text()
                    .color(DARK_AQUA)
                    .append(text("     "))
                    .append(translatable("flower.command.info.online-players-key"))
                    .append(text(": "))
                    ...
                    .append(text()
                            ...
                            .append(OPEN_BRACKET)
                            .append(translatable()
                                    .key("flower.command.info.online-players-unique")
            ...
            prefixed(text()
                    .color(DARK_AQUA)
                    .append(text("     "))
                    .append(translatable("flower.command.info.uptime-key"))
                    .append(text(": "))
            ...
            prefixed(text()
                    .color(DARK_AQUA)
                    .append(text("     "))
                    .append(translatable("flower.command.info.local-data-key"))
                    .append(text(": "))
                    .append(translatable()
                            .key("flower.command.info.local-data")
                            .color(GRAY)
                            .arguments(
    ...
    Args0 EXPORT_ALREADY_RUNNING = () -> prefixed(text()
            ...
            .color(RED)
            .append(translatable("flower.command.export.already-running"))
            .append(FULL_STOP)
            .append(space())
            .append(translatable("flower.command.misc.wait-to-finish"))
            .append(FULL_STOP)
    );
    ...
    Args1<String> EXPORT_FILE_ALREADY_EXISTS = file -> prefixed(text()
            ...
            .color(RED)
            .append(translatable("flower.command.export.error-term"))
            .append(text(": "))
            .append(translatable("flower.command.export.file.already-exists", text(file, DARK_RED)))
            .append(FULL_STOP)
    );

    Args0 EXPORT_FILE_FAILURE = () -> prefixed(translatable()
            // "&cAn unexpected error occured whilst writing to the file."
            .key("flower.command.export.file-unexpected-error-writing")
            .color(RED)
            .append(FULL_STOP)
    );
    ...
    Args1<String> EXPORT_FILE_NOT_WRITABLE = file -> prefixed(text()
            ...
            .append(translatable("flower.command.export.error-term"))
            .append(text(": "))
            .append(translatable("flower.command.export.file.not-writable", text(file, DARK_RED)))
            .append(FULL_STOP)
    );

    Args1<String> EXPORT_LOG = msg -> prefixed(text()
            // "&3EXPORT &3&l> &f{}"
            .append(translatable("flower.logs.export-prefix", DARK_AQUA))
            .append(space())
    ...
    Args1<String> EXPORT_FILE_SUCCESS = file -> prefixed(translatable()
            ...
            .key("flower.command.export.file.success")
            .color(GREEN)
    ...
    Args0 IMPORT_ALREADY_RUNNING = () -> prefixed(text()
            ...
            .color(RED)
            .append(translatable("flower.command.import.already-running"))
            .append(FULL_STOP)
            .append(space())
            .append(translatable("flower.command.misc.wait-to-finish"))
            .append(FULL_STOP)
    ...
    Args1<String> FILE_NOT_WITHIN_DIRECTORY = file -> prefixed(text()
            ...
            .color(RED)
            .append(translatable("flower.command.import.error-term"))
            .append(text(": "))
            .append(translatable("flower.command.misc.file-must-be-in-data", text(file, DARK_RED)))
            .append(FULL_STOP)
    );
    ...
    Args1<String> IMPORT_FILE_DOESNT_EXIST = file -> prefixed(text()
            ...
            .append(translatable("flower.command.import.error-term"))
            .append(text(": "))
            .append(translatable("flower.command.import.file.doesnt-exist", text(file, DARK_RED)))
            .append(FULL_STOP)
    );
    ...
    Args1<String> IMPORT_FILE_NOT_READABLE = file -> prefixed(text()
            ...
            .append(translatable("flower.command.import.error-term"))
            .append(text(": "))
            .append(translatable("flower.command.import.file.not-readable", text(file, DARK_RED)))
            .append(FULL_STOP)
    );
    ...
    Args0 IMPORT_FILE_READ_FAILURE = () -> prefixed(text()
            ...
            .color(RED)
            .append(translatable("flower.command.import.file.unexpected-error-reading"))
            .append(FULL_STOP)
            .append(space())
            .append(text()
                    .append(OPEN_BRACKET)
                    .append(translatable("flower.command.import.file.correct-format"))
                    .append(CLOSE_BRACKET)
            )
    );
    ...
    Args3<Integer, Integer, Integer> IMPORT_PROGRESS = (percent, processed, total) -> prefixed(text()
            ...
            .append(text()
                    .color(AQUA)
                    .append(OPEN_BRACKET)
                    .append(translatable("flower.command.import.term"))
                    .append(CLOSE_BRACKET)
            )
            .append(text(" -> ", AQUA))
            .append(translatable("flower.command.import.progress.percent", WHITE, text(percent)))
            .append(text(" - ", GRAY))
            .append(translatable()
                    .key("flower.command.import.progress.operations")
                    .color(WHITE)
    ...
    Args0 IMPORT_START = () -> prefixed(text()
            ...
            .append(text(" -> ", AQUA))
            .append(translatable("flower.command.import.starting"))
            .append(FULL_STOP)
    );
    ...
    Args1<Double> IMPORT_END_COMPLETE = seconds -> prefixed(text()
            ...
            .append(space())
            .append(translatable("flower.command.import.completed", GREEN, BOLD))
            .append(text(" - "))
            .append(translatable("flower.command.import.duration", text(seconds, AQUA)))
            .append(FULL_STOP)
    );
    ...
    Args4<String, String, Component, Boolean> USER_INFO_GENERAL = (username, uuid, uuidType, online) -> joinNewline(
            ...
            prefixed(text()
                    ...
                    .append(space())
                    .append(translatable("flower.command.user.info.title"))
                    .append(text(": "))
                    .append(text(username, WHITE))),
            prefixed(text()
                    .color(DARK_AQUA)
                    .append(text("- ", WHITE))
                    .append(translatable("flower.command.user.info.uuid-key"))
                    .append(text(": "))
            ...
            prefixed(text()
                    ...
                    .append(text("    "))
                    .append(OPEN_BRACKET)
                    .append(translatable("flower.command.user.info.uuid-type-key"))
                    .append(text(": "))
                    .append(uuidType)
                    .append(CLOSE_BRACKET)),
            prefixed(text()
                    .color(DARK_AQUA)
                    .append(text("- ", WHITE))
                    .append(translatable("flower.command.user.info.status-key"))
                    .append(text(": "))
                    .append(online ? translatable("flower.command.user.info.status.online", GREEN) : translatable("flower.command.user.info.status.offline", RED)))
    );

    Args0 TRANSLATIONS_SEARCHING = () -> prefixed(translatable()
            // "&7Searching for available translations, please wait..."
            .key("flower.command.translations.searching")
            .color(GRAY)
    );

    Args1<Collection<String>> INSTALLED_TRANSLATIONS = locales -> prefixed(translatable()
            // "&aInstalled Translations:"
            .key("flower.command.translations.installed-translations")
            .color(GREEN)
            .append(text(':'))
            .append(space())
    ...
    static Component formatStringList(Collection<String> strings) {
        ...
        if (!it.hasNext()) {
            return translatable("flower.command.misc.none", AQUA); // "&bNone"
        }
