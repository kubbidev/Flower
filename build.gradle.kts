...
tasks.shadowJar {
    archiveFileName = "flower-bukkit.jarinjar"

    dependencies {
        include(dependency("me.kubbidev.flower:.*"))
    }

    relocate("net.kyori.event", "me.kubbidev.flower.lib.eventbus")
    relocate("com.github.benmanes.caffeine", "me.kubbidev.flower.lib.caffeine")
    relocate("okio", "me.kubbidev.flower.lib.okio")
    relocate("okhttp3", "me.kubbidev.flower.lib.okhttp3")
    relocate("net.bytebuddy", "me.kubbidev.flower.lib.bytebuddy")
    relocate("me.lucko.commodore", "me.kubbidev.flower.lib.commodore")
    relocate("org.mariadb.jdbc", "me.kubbidev.flower.lib.mariadb")
    relocate("com.mysql", "me.kubbidev.flower.lib.mysql")
    relocate("org.postgresql", "me.kubbidev.flower.lib.postgresql")
    relocate("com.zaxxer.hikari", "me.kubbidev.flower.lib.hikari")
    relocate("com.mongodb", "me.kubbidev.flower.lib.mongodb")
    relocate("org.bson", "me.kubbidev.flower.lib.bson")
    relocate("redis.clients.jedis", "me.kubbidev.flower.lib.jedis")
    relocate("io.nats.client", "me.kubbidev.flower.lib.nats")
    relocate("com.rabbitmq", "me.kubbidev.flower.lib.rabbitmq")
    relocate("org.apache.commons.pool2", "me.kubbidev.flower.lib.commonspool2")
    relocate("ninja.leaping.configurate", "me.kubbidev.flower.lib.configurate")
}
